...
('OCC_COMPORTEMENT', 'Comportement des occurrences observées', 'Comportement des occurrences observées', 'Nomenclature des domportement des occurrences observées', 'SINP', 'Validé', '2020-08-31 00:00:00', '2020-08-31 00:00:00');
...
(ref_nomenclatures.get_id_nomenclature_type('OCC_COMPORTEMENT'), '0', 'NSP', 'Inconnu', 'Inconnu', 'Inconnu : Le statut biologique de l''individu n''est pas connu.', 'SINP', 'Validé', 0, '2020-08-31 00:00:00', '2020-08-31 00:00:00', true)
,(ref_nomenclatures.get_id_nomenclature_type('OCC_COMPORTEMENT'), '1', '1', 'Non renseigné', 'Non renseigné', 'Non renseigné : Le statut biologique de l''individu n''a pas été renseigné.', 'SINP', 'Validé', 0, '2020-08-31 00:00:00', '2020-08-31 00:00:00', true)
,(ref_nomenclatures.get_id_nomenclature_type('OCC_COMPORTEMENT'), '2', '2', 'Echouage', 'Echouage', 'Echouage : l''individu tente de s''échouer ou vient de s''échouer sur le rivage', 'SINP', 'Validé', 0, '2020-08-31 00:00:00', '2020-08-31 00:00:00', true)
,(ref_nomenclatures.get_id_nomenclature_type('OCC_COMPORTEMENT'), '3', '3', 'Dortoir', 'Dortoir', 'Dortoir : individus se regroupant dans une zone définie pour y passer la nuit ou la journée.', 'SINP', 'Validé', 0, '2020-08-31 00:00:00', '2020-08-31 00:00:00', true)
,(ref_nomenclatures.get_id_nomenclature_type('OCC_COMPORTEMENT'), '4', '4', 'Migration', 'Migration', 'Migration : L''individu (ou groupe d''individus) est en migration active', 'SINP', 'Validé', 0, '2020-08-31 00:00:00', '2020-08-31 00:00:00', true)
,(ref_nomenclatures.get_id_nomenclature_type('OCC_COMPORTEMENT'), '5', '5', 'Construction de toile', 'Construction de toile', 'Construction de toile : l''individu construit sa toile', 'SINP', 'Validé', 0, '2020-08-31 00:00:00', '2020-08-31 00:00:00', true)
,(ref_nomenclatures.get_id_nomenclature_type('OCC_COMPORTEMENT'), '6', '6', 'Halte migratoire', 'Halte migratoire', 'Halte migratoire : Indique que l''individu procède à une halte au cours de sa migration, et a été découvert sur sa zone de halte.', 'SINP', 'Validé', 0, '2020-08-31 00:00:00', '2020-08-31 00:00:00', true)
,(ref_nomenclatures.get_id_nomenclature_type('OCC_COMPORTEMENT'), '7', '7', 'Swarming', 'Swarming', 'Swarming : Indique que l''individu a un comportement de swarming : il se regroupe avec d''autres individus de taille similaire, sur une zone spécifique, ou en mouvement.', 'SINP', 'Validé', 0, '2020-08-31 00:00:00', '2020-08-31 00:00:00', true)
,(ref_nomenclatures.get_id_nomenclature_type('OCC_COMPORTEMENT'), '8', 'ChassAlim', 'Chasse/alimentation', 'Chasse/alimentation', 'Chasse / alimentation : Indique que l''individu est sur une zone qui lui permet de chasser ou de s''alimenter.', 'SINP', 'Validé', 0, '2020-08-31 00:00:00', '2020-08-31 00:00:00', true)
,(ref_nomenclatures.get_id_nomenclature_type('OCC_COMPORTEMENT'), '9', 'Hivernage', 'Hivernage', 'Hivernage', 'Hivernage : l''individu hiverne (modification de son comportement liée à l''hiver pouvant par exemple comporter un changement de lieu, d''alimentation, de production de sève ou de graisse...)', 'SINP', 'Validé', 0, '2020-08-31 00:00:00', '2020-08-31 00:00:00', true)
,(ref_nomenclatures.get_id_nomenclature_type('OCC_COMPORTEMENT'), '10', '10', 'Passage en vol', 'Passage en vol', 'Passage en vol : Indique que l''individu est de passage et en vol.', 'SINP', 'Validé', 0, '2020-08-31 00:00:00', '2020-08-31 00:00:00', true)
,(ref_nomenclatures.get_id_nomenclature_type('OCC_COMPORTEMENT'), '11', '11', 'Erratique', 'Erratique', 'Erratique : Individu d''une ou de populations d''un taxon qui ne se trouve, actuellement, que de manière occasionnelle dans les limites d’une région. Il a été retenu comme seuil, une absence de 80% d''un laps de temps donné (année, saisons...).', 'SINP', 'Validé', 0, '2020-08-31 00:00:00', '2020-08-31 00:00:00', true)
,(ref_nomenclatures.get_id_nomenclature_type('OCC_COMPORTEMENT'), '12', '12', 'Sédentaire', 'Sédentaire', 'Sédentaire : Individu demeurant à un seul emplacement, ou restant toute l''année dans sa région d''origine, même s''il effectue des déplacements locaux.', 'SINP', 'Validé', 0, '2020-08-31 00:00:00', '2020-08-31 00:00:00', true)
...
,(ref_nomenclatures.get_id_nomenclature_type('OCC_COMPORTEMENT'), '14', '14', 'Nourrissage des jeunes', 'Nourrissage des jeunes', 'Nourrissage des jeunes', 'SINP', 'Validé', 0, '2020-08-31 00:00:00', '2020-08-31 00:00:00', true)
,(ref_nomenclatures.get_id_nomenclature_type('OCC_COMPORTEMENT'), '15', '15', 'Posé', 'Posé', 'Posé : Individu(s) posé(s)', 'SINP', 'Validé', 0, '2020-08-31 00:00:00', '2020-08-31 00:00:00', true)
,(ref_nomenclatures.get_id_nomenclature_type('OCC_COMPORTEMENT'), '16', '16', 'Déplacement', 'Déplacement', 'Déplacement : Individu(s) en déplacement', 'SINP', 'Validé', 0, '2020-08-31 00:00:00', '2020-08-31 00:00:00', true)
,(ref_nomenclatures.get_id_nomenclature_type('OCC_COMPORTEMENT'), '17', '17', 'Repos', 'Repos', 'Repos', 'SINP', 'Validé', 0, '2020-08-31 00:00:00', '2020-08-31 00:00:00', true)
,(ref_nomenclatures.get_id_nomenclature_type('OCC_COMPORTEMENT'), '18', '18', 'Chant', 'Chant', 'Chant', 'SINP', 'Validé', 0, '2020-08-31 00:00:00', '2020-08-31 00:00:00', true)
,(ref_nomenclatures.get_id_nomenclature_type('OCC_COMPORTEMENT'), '19', '19', 'Accouplement', 'Accouplement', 'Accouplement', 'SINP', 'Validé', 0, '2020-08-31 00:00:00', '2020-08-31 00:00:00', true)
,(ref_nomenclatures.get_id_nomenclature_type('OCC_COMPORTEMENT'), '20', '20', 'Cœur copulatoire', 'Cœur copulatoire', 'Cœur copulatoire', 'SINP', 'Validé', 0, '2020-08-31 00:00:00', '2020-08-31 00:00:00', true)
,(ref_nomenclatures.get_id_nomenclature_type('OCC_COMPORTEMENT'), '21', '21', 'Tandem', 'Tandem', 'Tandem', 'SINP', 'Validé', 0, '2020-08-31 00:00:00', '2020-08-31 00:00:00', true)
,(ref_nomenclatures.get_id_nomenclature_type('OCC_COMPORTEMENT'), '22', '22', 'Territorial', 'Territorial', 'Territorial', 'SINP', 'Validé', 0, '2020-08-31 00:00:00', '2020-08-31 00:00:00', true)
,(ref_nomenclatures.get_id_nomenclature_type('OCC_COMPORTEMENT'), '23', '23', 'Pond', 'Pond', 'Pond', 'SINP', 'Validé', 0, '2020-08-31 00:00:00', '2020-08-31 00:00:00', true)
