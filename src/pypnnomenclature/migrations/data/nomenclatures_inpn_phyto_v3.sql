...
(ref_nomenclatures.get_id_nomenclature_type('BRAUNBARK'), 'i', 'IndI', 'Un seul individu présent, recouvrement très faible (<5%)', 'Un seul individu présent, recouvrement très faible (<5%)', 'Un seul individu présent, recouvrement très faible (<5%)', 'Un seul individu présent, recouvrement très faible (<5%)', 'SINP', 'Validé', '0', LPAD(ref_nomenclatures.get_id_nomenclature_type('BRAUNBARK')::text, 3, '0') || '.' || LPAD('1', 3, '0'), true),
(ref_nomenclatures.get_id_nomenclature_type('BRAUNBARK'), 'r', 'IndR', 'Individus rares ou très rares, recouvrement faible (<5%)', 'Individus rares ou très rares, recouvrement faible (<5%)', 'Individus rares ou très rares, recouvrement faible (<5%)', 'Individus rares ou très rares, recouvrement faible (<5%)', 'SINP', 'Validé', '0', LPAD(ref_nomenclatures.get_id_nomenclature_type('BRAUNBARK')::text, 3, '0') || '.' || LPAD('2', 3, '0'), true),
(ref_nomenclatures.get_id_nomenclature_type('BRAUNBARK'), '+', 'IndPA', 'Individus peu abondants, recouvrement faible (<5%)', 'Individus peu abondants, recouvrement faible (<5%)', 'Individus peu abondants, recouvrement faible (<5%)', 'Individus peu abondants, recouvrement faible (<5%)', 'SINP', 'Validé', '0', LPAD(ref_nomenclatures.get_id_nomenclature_type('BRAUNBARK')::text, 3, '0') || '.' || LPAD('3' , 3, '0'), true),
(ref_nomenclatures.get_id_nomenclature_type('BRAUNBARK'), '1', 'Ind1', 'Individus assez abondants, recouvrement faible (< 5%)', 'Individus assez abondants, recouvrement faible (< 5%)', 'Individus assez abondants, recouvrement faible (< 5%)', 'Individus assez abondants, recouvrement faible (< 5%)', 'SINP', 'Validé', '0', LPAD(ref_nomenclatures.get_id_nomenclature_type('BRAUNBARK')::text, 3, '0') || '.' || LPAD('4', 3, '0'), true),
(ref_nomenclatures.get_id_nomenclature_type('BRAUNBARK'), '2', 'Ind2', 'Individus abondants, recouvrement de 5 à 25%', 'Individus abondants, recouvrement de 5 à 25%', 'Individus abondants, recouvrement de 5 à 25%', 'Individus abondants, recouvrement de 5 à 25%', 'SINP', 'Validé', '0', LPAD(ref_nomenclatures.get_id_nomenclature_type('BRAUNBARK')::text, 3, '0') || '.' || LPAD('5', 3, '0'), true),
(ref_nomenclatures.get_id_nomenclature_type('BRAUNBARK'), '2m', 'Ind2m', 'Individus abondants, recouvrement < 5%', 'Individus abondants, recouvrement < 5%', 'Individus abondants, recouvrement < 5%', 'Individus abondants, recouvrement < 5%', 'SINP', 'Validé', '0', LPAD(ref_nomenclatures.get_id_nomenclature_type('BRAUNBARK')::text, 3, '0') || '.' || LPAD('6', 3, '0'), true),
(ref_nomenclatures.get_id_nomenclature_type('BRAUNBARK'), '2a', 'Ind2a', 'Individus en nombre quelconque, recouvrement entre 5 et 12,5%', 'Individus en nombre quelconque, recouvrement entre 5 et 12,5%', 'Individus en nombre quelconque, recouvrement entre 5 et 12,5%', 'Individus en nombre quelconque, recouvrement entre 5 et 12,5%', 'SINP', 'Validé', '0', LPAD(ref_nomenclatures.get_id_nomenclature_type('BRAUNBARK')::text, 3, '0') || '.' || LPAD('7', 3, '0'), true),
(ref_nomenclatures.get_id_nomenclature_type('BRAUNBARK'), '2b', 'Ind2b', 'Individus en nombre quelconque, recouvrement entre 12,5 et 25%', 'Individus en nombre quelconque, recouvrement entre 12,5 et 25%', 'Individus en nombre quelconque, recouvrement entre 12,5 et 25%', 'Individus en nombre quelconque, recouvrement entre 12,5 et 25%', 'SINP', 'Validé', '0', LPAD(ref_nomenclatures.get_id_nomenclature_type('BRAUNBARK')::text, 3, '0') || '.' || LPAD('8', 3, '0'), true),
(ref_nomenclatures.get_id_nomenclature_type('BRAUNBARK'), '3', 'Ind3', 'Individus en nombre quelconque, recouvrement entre 25 et 50%', 'Individus en nombre quelconque, recouvrement entre 25 et 50%', 'Individus en nombre quelconque, recouvrement entre 25 et 50%', 'Individus en nombre quelconque, recouvrement entre 25 et 50%', 'SINP', 'Validé', '0', LPAD(ref_nomenclatures.get_id_nomenclature_type('BRAUNBARK')::text, 3, '0') || '.' || LPAD('9', 3, '0'), true),
(ref_nomenclatures.get_id_nomenclature_type('BRAUNBARK'), '4', 'Ind4', 'Individus en nombre quelconque, recouvrement entre 50 et 75%', 'Individus en nombre quelconque, recouvrement entre 50 et 75%', 'Individus en nombre quelconque, recouvrement entre 50 et 75%', 'Individus en nombre quelconque, recouvrement entre 50 et 75%', 'SINP', 'Validé', '0', LPAD(ref_nomenclatures.get_id_nomenclature_type('BRAUNBARK')::text, 3, '0') || '.' || LPAD('10', 3, '0'), true),
(ref_nomenclatures.get_id_nomenclature_type('BRAUNBARK'), '5', 'Ind5', 'Individus en nombre quelconque, recouvrement > 75%', 'Individus en nombre quelconque, recouvrement > 75%', 'Individus en nombre quelconque, recouvrement > 75%', 'Individus en nombre quelconque, recouvrement > 75%', 'SINP', 'Validé', '0', LPAD(ref_nomenclatures.get_id_nomenclature_type('BRAUNBARK')::text, 3, '0') || '.' || LPAD('11', 3, '0'), true)
;
